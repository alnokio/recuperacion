          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
              ...
              <div className="flex gap-4">
                <Link
                  to={`/games/${game.id}`}
                  className="hover:bg-black text-white px-6 py-2 rounded-lg transition border-1 border-white text-decoration-none"
                >
                  DETALLES
                </Link>
                <Link to="/" className="hover:bg-black text-white px-6 py-2 rounded-lg transition border-1 border-white text-decoration-none">
                  TODOS LOS JUEGOS
                </Link>
              </div>
            </div>
