...
const GameDetails = observer(() => {
  ...
  return (
    <Container className="py-5">
      <Link to="/" className="btn mb-4 text-black px-6 py-2 rounded-lg transition border-1 border-black text-decoration-none">
      ...
      <Card className="shadow-lg overflow-hidden">
        ...
        <div className="position-relative">
          ...
          <div className="position-absolute bottom-0 start-0 end-0 p-3  bg-opacity-75 text-white">
          ...
          <div className="text-center mt-4">
            {game.website && (
              <Button
                ...
                variant="primary"
                className="border-black text-decoration-none"
              >
                <i className="bi bi-globe me-1"></i> GAME WEBSITE
              </Button>
            )}
            <Button as={Link} to="/" variant="secondary" className="btn-danger">
